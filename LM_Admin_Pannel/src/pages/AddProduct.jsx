...
// };
const divideStockEqually = (
  totalStock,
  count
) => {
  const total =
    parseStockValue(totalStock);
...
const buildCombinations = (variantOptions, existingVariants, defaults) => {
  ...
  return combos.map((combo, index) => {
    ...
    return {
      ...
      size:
        getOptionValue(combo, "size") ||
        null,
      color:
        getOptionValue(combo, "color") ||
        null,
...
payload.append(
  ...
  setForm((prev) => {
    if (value === "meter") {
      return {
        ...
        unit_name: "meter",
        minimum_quantity:
          prev.sale_mode === "meter"
            ? prev.minimum_quantity
            : "1",
        quantity_step:
          prev.sale_mode === "meter"
            ? prev.quantity_step
  ...
  <div className="space-y-2">
    ...
    <p className="text-xs text-muted-foreground">
      {form.sale_mode === "meter"
        ? "Product price will be treated as price per meter."
        : "Product price will be treated as price per piece."}
    </p>
  </div>
</div>
...
{form.sale_mode === "meter" && (
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div className="space-y-2">
      ...
      <p className="text-xs text-muted-foreground">
        Example: customer must buy at least 1 meter.
      </p>
    </div>
