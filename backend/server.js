...
} = require("./src/config/runMigrations");

const {
  storeMiddleware,
} = require("./src/middleware/storeMiddleware");
...
const {
  sanitizeMiddleware,
} = require("./src/helpers/sanitizeHelper");
...
const bannerVideoRoutes = require("./src/routes/bannerVideoRoutes");
...
const storefrontAuthRoutes = require(
  "./src/routes/storefrontAuthRoutes"
);

const storefrontOrderRoutes = require(
  "./src/routes/storefrontOrderRoutes"
);

const storefrontPaymentRoutes = require(
  "./src/routes/storefrontPaymentRoutes"
);
...
const recentlyViewedRoutes = require(
  "./src/routes/recentlyViewedRoutes"
);
